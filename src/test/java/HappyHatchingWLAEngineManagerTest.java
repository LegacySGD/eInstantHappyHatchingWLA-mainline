...
public class HappyHatchingWLAEngineManagerTest {
	...
	public void setUp() throws Exception {
		logger = Logger.getLogger(HappyHatchingWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/HappyHatchingWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/HappyHatchingWLAIW/InitOutcome.xml").getDocumentElement();
